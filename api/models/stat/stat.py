            ...
            with
                res as (
                    select
                      ...
                      st.agg_sep_value as st_agg_sep_value,
                      st.agg_sep_value_extra as st_agg_sep_value_extra,
                      ...
                      st.series_sep_value as st_series_sep_value,
                      st.series_sep_value_extra as st_series_sep_value_extra,
