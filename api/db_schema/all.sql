...
insert into meta (device,name,data_id,system1,category) values ('robot','Darab lerakva a GOM-ra (Nyers)', 'place_gom','log','EVENT');
insert into meta (device,name,data_id,system1,category) values ('robot','GOM mérés OK (Nyers)', 'gom_good','log','EVENT');
insert into meta (device,name,data_id,system1,category) values ('robot','GOM mérés NOK (Nyers)', 'gom_bad','log','EVENT');
insert into meta (device,name,data_id,system1,category) values ('robot','Darab felvéve a GOM-ról (Nyers)', 'takeout_gom','log','EVENT');
...
insert into meta (device,name,data_id,system1,category) values ('robot','Darab lerakva a GOM-ra (Kész)', 'place_gom','log','EVENT');
insert into meta (device,name,data_id,system1,category) values ('robot','GOM mérés OK (Kész)', 'gom_good','log','EVENT');
insert into meta (device,name,data_id,system1,category) values ('robot','GOM mérés NOK (Kész)', 'gom_bad','log','EVENT');
insert into meta (device,name,data_id,system1,category) values ('robot','Darab felvéve a GOM-ról (Kész)', 'pickout_gom','log','EVENT');
...
insert into meta values ('lathe', 'connect', 'connect', NULL, NULL, NULL, 'CONDITION', 'CONDITION', NULL, NULL);
...
insert into meta values ('lathe', 'install_tool', 'install_tool', NULL, NULL, NULL, 'EVENT', NULL, NULL, NULL);
insert into meta values ('lathe', 'remove_tool', 'install_tool', NULL, NULL, NULL, 'EVENT', NULL, NULL, NULL);
...
insert into meta values ('mill', 'connect', 'connect', NULL, NULL, NULL, 'CONDITION', 'CONDITION', NULL, NULL);
...
insert into meta values ('mill', 'install_tool', 'install_tool', NULL, NULL, NULL, 'EVENT', NULL, NULL, NULL);
insert into meta values ('mill', 'remove_tool', 'install_tool', NULL, NULL, NULL, 'EVENT', NULL, NULL, NULL);
