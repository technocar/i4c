...
import models.log
import common
from I4cAPI import I4cApiRouter, CancelOnDisconnect
...
async def find(
    ...
    """List log entries."""
    rs = await disconnector(models.log.get_find(credentials, device, timestamp, sequence, before_count, after_count, categ, data_id, val, extra, rel))
    if rs is None:
