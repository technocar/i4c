    ...
    while True:
        ...
        for notif in notifs:
            ...
            try:
                ...
                # TODO we could also implement a back-off mechanism
                #   after first failure, retry next time
                #   after second failure, delay 10s
                #   after third failure, delay 1min
                #   after that, give up, and set to fail
